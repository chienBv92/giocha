...
namespace Web_Gio_Cha.ReportServices
{
    using Web_Gio_Cha.UtilityServices;
    using System;
    ...
    using Web_Gio_Cha.Controllers;
    using Web_Gio_Cha.Models;
    /// <summary>
    /// Report services
    /// </summary>
    public class ReportServices: Controller
    {
        ...
        public static void ExportToCsvData(Controller controller, DataTable dt, string fileName = "data.csv", string[] columns = null)
        {
            ...
            DownloadUtil.AddHeaderContentDisposition(System.Web.HttpContext.Current.Request, controller.Response, fileName);
